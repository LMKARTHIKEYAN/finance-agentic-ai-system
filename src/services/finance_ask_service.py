...
class FinanceAskService:
    ...
    def __init__(
        ...
        if (
            ...
            and not isinstance(memory_manager, MemoryManager)
        ):
            raise TypeError(
                "memory_manager must be MemoryManager or None."
            )
    ...
    def ask(
        ...
        *,
        ...
        try:
            graph_result = self._execute_graph(
                graph_state
            )
        ...
        return AskServiceResult(
            ...
            report_memory_id=graph_result.get(
                "report_memory_id"
            ),
    ...
    def _execute_graph(
        ...
        """Execute LangGraph with optional memory integration."""
